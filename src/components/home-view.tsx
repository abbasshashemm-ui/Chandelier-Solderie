...
export function HomeView({ products }: HomeViewProps) {
  return (
    <>
      ...
      <main className="flex min-h-[calc(100vh-var(--cs-header-height))] flex-col pt-[var(--cs-header-height)]">
        <section className="mx-auto flex w-full max-w-[1340px] flex-col items-center px-3 pb-6 pt-1 sm:px-4 md:px-8 md:pb-8 md:pt-2">
          <CatalogueWelcome />

          <Link
            href="/shop"
            className="mt-5 min-h-11 border border-[#c9a962]/35 bg-white/45 px-6 py-3.5 font-sans text-[0.6875rem] uppercase tracking-[0.14em] text-[#1a1a1a] backdrop-blur-md transition hover:border-[#c9a962] hover:bg-[#c9a962] hover:text-white sm:px-8"
          >
